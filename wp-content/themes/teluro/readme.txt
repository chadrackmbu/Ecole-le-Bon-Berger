...
Teluro is a beautiful, extremely customizable, multipurpose theme that you can use to create an amazing website by drag and drop. It comes with a predesigned home page, 5 header designs and over 35 ready to use content blocks that you can easily customize. You can also design your own custom blocks by combining over 25 drag and drop components. Teluro has lots of customization options (video background, slideshow background, header content types, etc) that will help you create a website that stands out in no time. It is also responsive so it works on mobile devices out of the box. Teluro is the only theme you will ever need! CHECK OUT THE DEMOS: https://teluro.com/go/demos


== Frequently Asked Questions ==

= How can I customize Teluro? =

    To customize the Teluro theme you have to open the Customizer by accessing the Appearance menu -> Customizer.


== License ==

Teluro WordPress theme, Copyright (C) 2021 ExtendThemes
Teluro WordPress theme is licensed under the GPL3.
...
* Images 
      The following SVG files are the creation of ExtendThemes and are distributed under the Creative Commons Zero License, http://creativecommons.org/publicdomain/zero/1.0/
        ...
        These assets are distributed under the CC0 License
               ...
               Source: https://pxhere.com/en/photo/232
               ...
               resources/images/images-xheader-default-0-1545411152082.jpg, Copyright ashishappl
               License: CC0 1.0 Universal (CC0 1.0)
               ...
               resources/header-presets/images/slide-3-sea-body-of-water-beach-sky-blue-ocean-1589419-pxhere.com_.jpg, Copyright Chalrempol sakorn
               License: CC0 1.0 Universal (CC0 1.0)
               ...
               resources/header-presets/images/small-attractive-beach-beautiful-bikini-blurred-background-body-1418560-pxhere.com_.jpg, Copyright Widehere
               License: CC0 1.0 Universal (CC0 1.0)
