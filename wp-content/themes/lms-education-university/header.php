...
<div class="header-box">
	<div class="top-header text-center py-3">
		<div class="container">
			<div class="row">
				<div class="col-lg-7 col-md-5 align-self-center text-md-right text-center top-head">
			    ...
			    <div class="col-lg-3 col-md-5 align-self-center text-md-right text-center top-button">
