<?php
/**
 * education center pro Customizer Repeater Control.
 * 
...
if( ! class_exists( 'Education_Center_Control_Repeater' ) ) {
    /**
     * Repeater control
     */
    class Education_Center_Control_Repeater extends WP_Customize_Control {
