...
if ( ! defined( 'ADVENTURE_TRAVELLING_FREE_THEME_URL' ) ) {
	define( 'ADVENTURE_TRAVELLING_FREE_THEME_URL', 'https://www.themespride.com/themes/free-hotel-booking-wordpress-theme/' );
}
if ( ! defined( 'ADVENTURE_TRAVELLING_DEMO_THEME_URL' ) ) {
	define( 'ADVENTURE_TRAVELLING_DEMO_THEME_URL', 'https://www.themespride.com/resort-hotel-booking-pro/' );
}
if ( ! defined( 'ADVENTURE_TRAVELLING_DOCS_THEME_URL' ) ) {
    define( 'ADVENTURE_TRAVELLING_DOCS_THEME_URL', 'https://www.themespride.com/demo/docs/resort-hotel-booking/' );
}
if ( ! defined( 'ADVENTURE_TRAVELLING_DOCS_URL' ) ) {
	define( 'ADVENTURE_TRAVELLING_DOCS_URL', esc_url('https://www.themespride.com/demo/docs/resort-hotel-booking/'));
}
...
define('RESORT_HOTEL_BOOKING_CREDIT',__('https://www.themespride.com/themes/free-hotel-booking-wordpress-theme/','resort-hotel-booking') );
if ( ! function_exists( 'resort_hotel_booking_credit' ) ) {
	function resort_hotel_booking_credit(){
		echo "<a href=".esc_url(RESORT_HOTEL_BOOKING_CREDIT)." target='_blank'>".esc_html__('Resort Hotel Booking WordPress Theme','resort-hotel-booking')."</a>";
	}
}
