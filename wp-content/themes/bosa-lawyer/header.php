...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'bosa-lawyer' ); ?></a>

	<?php if( get_theme_mod( 'header_layout', 'header_four' ) == '' || get_theme_mod( 'header_layout', 'header_four' ) == 'header_one' ){
