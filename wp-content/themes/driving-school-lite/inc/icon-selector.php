...
class Driving_School_Lite_Icon_Selector extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                      <div class="social-icon-search">
                          <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'driving-school-lite'); ?>">
                      </div>
                    <?php
                    $driving_school_lite_font_awesome_icon_array = driving_school_lite_font_awesome_icon_array();
                    foreach ($driving_school_lite_font_awesome_icon_array as $driving_school_lite_font_awesome_icon) {
                            $icon_class = $this->value() == $driving_school_lite_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($driving_school_lite_font_awesome_icon).'"></i>
                            <span class="driving-school-lite-social-class">'.esc_attr($driving_school_lite_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                  </ul>
...
function driving_school_lite_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'driving_school_lite_customizer_script' );

if(!function_exists('driving_school_lite_font_awesome_icon_array')){
    function driving_school_lite_font_awesome_icon_array(){
