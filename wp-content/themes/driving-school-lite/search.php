            ...
            <div class="container"> 
                <div class="row">       
                    <div class="col-lg-9 col-md-9">
                        <h1 class="search-title mb-4 text-center"><?php /* translators: %s: search term */ printf(esc_html('Search Results for: %s','driving-school-lite'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
