	...
	<div class="table-responsive">
		<table id="tableini" width="100%" class="table table-lightborder table-lightfont">
			...
			<tbody>
				...
				$exam = $wpdb->get_results( "SELECT exam_code, availablefrom, availableto, clock_start, clock_end, title, subject_id FROM {$wpdb->prefix}sakolawp_exams WHERE class_id = $class_id AND section_id = $section_id", ARRAY_A );
