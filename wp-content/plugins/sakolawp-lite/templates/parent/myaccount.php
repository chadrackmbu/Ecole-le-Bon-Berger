...
$student_id = get_user_meta( $current_id, 'related_student' , true );
	...
	<div class="dash-item skwp-column skwp-column-1">
		<div class="news-wrap">
			...
			<div class="loop-news skwp-dash-loop skwp-row skwp-clearfix">
				<?php $enroll = $wpdb->get_row( "SELECT class_id, section_id FROM {$wpdb->prefix}sakolawp_enroll WHERE student_id = $student_id");
				if(!empty($enroll)) : ?>
							...
							<tr>
								...
								<td class="simak-onlinee">
									...
									<?php if($terjawab == 'answered'):?>
										<a class="btn btn-rounded btn-sm btn-primary skwp-btn" href="<?php echo add_query_arg( array('exam_code' => esc_html($exam_code), 'student_id' => esc_html($student_id)), home_url( 'view_exam_result' ) );?>" ><?php esc_html_e('View Result', 'sakolawp'); ?></a>
									<?php endif; ?>
								</td>
							</tr>
						<?php endforeach; ?>
