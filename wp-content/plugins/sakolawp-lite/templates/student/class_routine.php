...
if(!empty($enroll)) :
$class = $wpdb->get_row( "SELECT class_id, name FROM {$wpdb->prefix}sakolawp_class WHERE class_id = $enroll->class_id");
$section = $wpdb->get_row( "SELECT section_id, name FROM {$wpdb->prefix}sakolawp_section WHERE section_id = $enroll->section_id");
...
<div class="routines-page skwp-content-inner skwp-clearfix">
