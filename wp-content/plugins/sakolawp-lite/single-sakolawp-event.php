...
$tags_name = array();
$tags_slugs = array();
$tags_terms = get_the_terms($post->ID, 'event-tags');
if(!empty($tags_terms)){
	...
	<div class="container">
		...
		<div class="single-wrapper clearfix">
			<div class="single-news">
				...
				<?php if(!empty($sakolawp_date_event)) { ?>
					<div class="single-event-meta-time skwp-clearfix">
						<div class="skwp-row">
							<div class="event-meta-txt skwp-column skwp-column-3">
								<div class="text-event-inner">
									<div class="text-event-inner-text">
										<span><?php esc_html_e('Event', 'sakolawp' ); ?></span>
										<span><?php esc_html_e('Start', 'sakolawp' ); ?></span>
									</div>
								</div>
							</div>
							<div class="event-meta-detail skwp-column skwp-column-2of3">
								<div class="detail-event-wrap">
									<div class="event-meta-date">
										<span class="detail-title"><?php esc_html_e('Date', 'sakolawp' ); ?></span><?php echo esc_html(': '); ?><span class="item-detail"><?php echo esc_html( $sakolawp_date_event ); ?></span>
									</div>
									<div class="event-meta-hour">
										<span class="detail-title"><?php esc_html_e('Time', 'sakolawp' ); ?></span><?php echo esc_html(': '); ?><?php echo esc_html( $sakolawp_hour_event ); ?>
									</div>
								</div>
							</div>
						</div>
