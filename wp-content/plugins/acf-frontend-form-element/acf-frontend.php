...
if ( !class_exists( 'Front_End_Admin' ) ) {
    ...
    define( 'FEA_PRO', 'https://www.dynamiapps.com/frontend-admin-for-acf/#pricing' );
    ...
    final class Front_End_Admin
    {
        ...
        public function admin_notice_get_pro()
        {
            ...
            <div class="notice notice-info acff-upgrade-pro-action" style="padding-right: 38px; position: relative;">
                <p> <?php printf( __( 'Try %s <b>Pro</b> free for 7 days!', FEA_NS ), FEA_TITLE ); ?> <a href="https://dynamiapps.com/try-frontend-admin-pro/" target="_blank">Check it out!</a> <a class="button button-primary" style="margin-left:20px;" href="https://dynamiapps.com/try-frontend-admin-pro/" target="_blank"><?php echo __( 'Free trial!', FEA_NS ) ?></a></p>
        ...
        public function admin_notice_review_plugin()
        {
            ...
            <li><a data-rate-action="do-rate" href="#" data-href="<?php echo esc_url( $review_url ); ?>"><?php esc_html_e( 'Ok, you deserve it', FEA_NS ); ?></a></li>
                <li><a data-rate-action="done-rating" href="#"><?php esc_html_e( 'I already did', FEA_NS ); ?></a></li>
                <li><a data-rate-action="not-yet" href="#"><?php esc_html_e( 'Nope, maybe later', FEA_NS ); ?></a></li>
            </ul>
            <div><img width="40px" src="<?php echo esc_url( $image_path ); ?>" style="width:40px;margin:10px"/></div>
        ...
        public function ajax_rate_the_plugin()
        {
            ...
            $rate_action = wp_kses( $_POST['rate_action'], 'strip' );
