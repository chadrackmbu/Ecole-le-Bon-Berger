...
/* 		public function frontend_admin_update_text_value( $value, $post_id = false, $field = false ){
		...
		public function include_field_types(){
			...
			include_once('fields/general/text-editor.php');
			...
			if( fea_instance()->is__premium_only() ){
				include_once(FEA_DIR . '/pro/forms/fields/general/form-step.php');
				include_once(FEA_DIR . '/pro/forms/fields/general/frontend-blocks.php');
			}
