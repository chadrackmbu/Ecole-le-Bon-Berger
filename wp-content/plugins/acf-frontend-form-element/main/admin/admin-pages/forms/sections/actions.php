...
$fields = array_merge( $fields, array(
    ...
    array(
        ...
        'field_label_hide' => true,
        'type' => 'textarea',
        'instructions' => __( 'There shouldn\'t be any problems with the form submission, but if there are, this is what your users will see. If you are expeiencing issues, try and changing your cache settings and reach out to ', FEA_NS ) . 'support@dynamiapps.com',
        'required' => 0,
    ...
    if( ! empty( $form['webhooks'] ) ){
     ...
     $fields[] = array(
        ...
        'block_labels' => array(
            ...
            'no_value'  => __( 'Click the button below to add your first action', FEA_NS ),
        ),
