	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'The term will be deleted. Are you sure?', FEA_NS ),
				'placeholder' => __( 'The term will be deleted. Are you sure?', FEA_NS ),
			]
		);
        ...
        $this->add_control( 'delete_message', [
            ...
            'default'     => __( 'You have deleted this term', FEA_NS ),
            'placeholder' => __( 'You have deleted this term', FEA_NS ),
            'dynamic'     => [
            'active' => true,
			'condition' => [
