...
class Delete_Product_Widget extends Widget_Base {
	...
	public function get_title() {
		return __( 'Trash/Delete Product', FEA_NS );
	}
	...
	protected function register_controls() {		
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'The product will be deleted. Are you sure?', FEA_NS ),
				'placeholder' => __( 'The product will be deleted. Are you sure?', FEA_NS ),
			]
		);
        ...
        $this->add_control( 'delete_message', [
            ...
            'default'     => __( 'You have deleted this product', FEA_NS ),
            'placeholder' => __( 'You have deleted this product', FEA_NS ),
            'dynamic'     => [
            'active' => true,
			'condition' => [
