    ...
    protected function register_actions_controls()
    {
        ...
        if ( fea_instance()->is__premium_only() ){
			...
			$this->add_control(
				...
				[
					'type' => Controls_Manager::RAW_HTML,
					'raw' => __( '<p><a target="_blank" href="https://www.dynamiapps.com/"><b>Go pro</b></a> to unlock more actions.</p>', FEA_NS ),
        ...
        $this->add_control( 'error_message', [
            ...
            'type'        => Controls_Manager::TEXTAREA,
            'description' => __( 'There shouldn\'t be any problems with the form submission, but if there are, this is what your users will see. If you are expeiencing issues, try and changing your cache settings and reach out to ', FEA_NS ) . 'support@dynamiapps.com',
    ...
    public function register_limit_controls()
    {
        ...
        if ( ! fea_instance()->is__premium_only() ) {
			$this->add_control(
				...
				[
					'type' => Controls_Manager::RAW_HTML,
					'raw' => __( '<p><a target="_blank" href="https://www.dynamiapps.com/"><b>Go pro</b></a> to unlock limit submissions.</p>', FEA_NS ),
					'content_classes' => 'acf-fields-note',
				]
			);
		}
    ...
    public function register_style_tab_controls(){				
		...
		if ( ! fea_instance()->is__premium_only() ) {
			...
			$this->add_control(
				...
				[
					'type' => Controls_Manager::RAW_HTML,
					'raw' => __( '<p><a target="_blank" href="https://www.dynamiapps.com/"><b>Go Pro</b></a> to unlock styles.</p>', FEA_NS ),
					'content_classes' => 'acf-fields-note',
				]
			);
