...
if( !class_exists( 'vxg_ccontact_data' ) ) {

/**
* since 1.0
*/
class vxg_ccontact_data extends vxg_ccontact{
/**
 ...
 */
  ...
  */
  ...
  global $wpdb;
  $table_name = $this->get_crm_table_name();
  $sql = $wpdb->prepare("SELECT * FROM $table_name WHERE form_id=%d and object = %s and account=%d and is_active=1 ORDER BY sort", $form_id,$object, $account);
  $results = $wpdb->get_results($sql, ARRAY_A);
  if(empty($results))
  return array();
