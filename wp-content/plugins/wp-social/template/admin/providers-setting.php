                                    ...
                                    <div class="wslu-popup-data">
                                        ...
                                        <div class="wslu-single-popup-item">
                                            ...
                                            <ol class="xs_social_ol">
                                                ...
                                                <li>
													<?php echo esc_attr_e('Check how to create App/Project On ' . $valueTypeAll . ' developer account - ', 'wp-social') ?>
                                        ...
                                        <div class="wslu-single-popup-item">
                                            <div class="setting-label-wraper">
                                                <label class="setting-label wslu-sec-title" for="<?php echo esc_attr($keyTypeAll); ?>_appid">
                                                    <?php echo wp_kses("App ID - <em>(Required)</em>", "wp-social", \WP_Social\Helper\Helper::get_kses_array()); ?>
                                                </label>
                                            </div>
                                        ...
                                        <div class="wslu-single-popup-item">
                                            <div class="setting-label-wraper">
                                                <label class="setting-label wslu-sec-title"
                                                       for="<?php echo esc_attr($keyTypeAll); ?>_secret"><?php echo wp_kses("App Secret - <em>(Required)</em>", "wp-social" , \WP_Social\Helper\Helper::get_kses_array()); ?></label>
                                            </div>
