                                        ...
                                        if(is_array($filedData)) {
											...
											foreach($filedData as $fk => $fv) {
                                                ...
                                                <div class="wslu-single-popup-item <?php echo esc_attr(($type == 'access') ? 'xs-access-button-inline' : ''); ?>">
													...
													if($type == 'access') {
														echo wp_kses('<button class="xs-btn btn-special small" data-type="modal-trigger" data-target="example-modal-' . $k . '">Get Access Token</button>', \WP_Social\Helper\Helper::get_kses_array());
													}
													...
													?>
                                                        ...
                                                        <select class="wslu-global-input"
															...
															<?php foreach($dataSelect as $dk => $dv) : ?>
                                                                <option value="<?php echo esc_attr($dk); ?>" <?php echo ($setId == $dk) ? 'selected' : ''; ?>><?php echo esc_attr($dv); ?> </option>
															<?php endforeach; ?>
                                                        </select>
														<?php
