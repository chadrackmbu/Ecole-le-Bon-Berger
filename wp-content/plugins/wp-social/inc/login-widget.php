...
class Login_widget extends \WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		*/
		...
		if( !$box_only ){
			echo esc_html($before_widget . $before_title . $title . $after_title);
		}

		echo wp_kses(xs_social_login_shortcode_widget( array('all'), $config), \WP_Social\Helper\Helper::get_kses_array());
